...
//NMEA2000_Msg_t NMEA_2000_Msg_ZIOM = {.Msg_ID = 127444, .Msg_DLC = 2};
...
void NMEA_Set_Values(NMEA2000_Msg_t* NMEA2000_MsgType)
{
	if(NMEA2000_MsgType == &NMEA_2000_Msg_EPRU)
	{
		...
		NMEA_2000_Msg_EPRU.NMEA2000_Msg_Data.NMEA2000_Msg_EPRU_Data.EngineSpeed = (110*BLDC_Motor_Msg_1.BLDC_Motor_Msg_1_Data.RotorSpeed/7000);// (110 * (BLDC_Motor_Msg_1.BLDC_Motor_Msg_1_Data.RotorSpeed / 7000));
